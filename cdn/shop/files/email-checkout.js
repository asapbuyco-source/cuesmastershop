...
(function () {
  ...
  (function injectStyles() {
    ...
    style.textContent = [
      ...
      '.cm-shaft-specs { margin: 2.5rem 0; padding: 2rem; background: #121212; border: 1px solid rgba(212,157,55,0.3); border-radius: 8px; }',
      '.cm-shaft-specs h3 { color: #d49d37; margin: 1.5rem 0 1rem; font-size: 1.6rem; }',
      '.cm-shaft-specs table { width: 100%; border-collapse: collapse; margin: 1rem 0; }',
      '.cm-shaft-specs th, .cm-shaft-specs td { text-align: left; padding: 0.9rem 1rem; border-bottom: 1px solid rgba(255,255,255,0.12); font-size: 1.35rem; vertical-align: top; }',
      '.cm-shaft-specs th { color: rgba(255,255,255,0.55); width: 34%; text-transform: uppercase; letter-spacing: 0.08em; font-size: 1.2rem; }',
      '.cm-shaft-specs p { font-size: 1.35rem; line-height: 1.6; color: rgba(255,255,255,0.8); margin: 0.8rem 0; }',
      '.cm-shaft-specs a { color: #d49d37; }',
      '.cm-shaft-trust { margin: 2.5rem 0; padding: 2rem; background: #121212; border: 1px solid rgba(212,157,55,0.3); border-radius: 8px; }',
      '.cm-shaft-trust-title { color: #d49d37; font-size: 1.5rem; letter-spacing: 0.2em; text-transform: uppercase; margin: 0 0 1rem; }',
      '.cm-shaft-trust ul { margin: 0; padding-left: 2rem; }',
      '.cm-shaft-trust li { color: rgba(255,255,255,0.8); font-size: 1.35rem; line-height: 1.6; margin: 0 0 0.7rem; }',
      '.cm-shaft-trust a { color: #d49d37; }',
      '.cm-shaft-intro { max-width: 100rem; margin: 0 auto; padding: 5rem 5rem 3rem; }',
      '.cm-shaft-eyebrow { color: #d49d37; font-size: 1.2rem; letter-spacing: 0.3em; text-transform: uppercase; margin: 0 0 1.2rem; }',
      '.cm-shaft-heading { font-size: clamp(2.6rem, 4.5vw, 4rem); line-height: 1.15; margin: 0 0 1.6rem; }',
      '.cm-shaft-lede { color: rgba(255,255,255,0.75); font-size: 1.6rem; line-height: 1.7; max-width: 76rem; margin: 0 0 3rem; }',
      '.cm-shaft-cats { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.6rem; margin: 0 0 2.5rem; }',
      '.cm-shaft-cat { display: block; background: #121212; border: 1px solid rgba(212,157,55,0.35); border-radius: 8px; padding: 2.2rem; text-decoration: none; transition: border-color 0.2s ease, transform 0.2s ease; }',
      '.cm-shaft-cat:hover { border-color: #d49d37; transform: translateY(-2px); }',
      '.cm-shaft-cat strong { display: block; color: #fff; font-size: 1.7rem; margin-bottom: 0.8rem; }',
      '.cm-shaft-cat span { color: rgba(255,255,255,0.65); font-size: 1.35rem; line-height: 1.5; }',
      '.cm-shaft-points { margin: 0 0 1.5rem; padding-left: 2rem; }',
      '.cm-shaft-points li { color: rgba(255,255,255,0.8); font-size: 1.4rem; line-height: 1.6; margin: 0 0 0.7rem; }',
      '.cm-shaft-note { color: rgba(255,255,255,0.55); font-size: 1.3rem; }',
      '.cm-shaft-intro a { color: #d49d37; }',
      '@media (max-width: 749px) { .cm-shaft-intro { padding: 3rem 1.5rem 2rem; } }',
