...
// Set your WhatsApp number in international format below, e.g. '639171234567'
const WHATSAPP_NUMBER = 'YOUR_PHONE_NUMBER_HERE';

if (!WHATSAPP_NUMBER || WHATSAPP_NUMBER.indexOf('YOUR_PHONE') === 0) {
  // No real number configured yet: don't render a broken chat link.
  console.warn('WhatsApp widget disabled: set WHATSAPP_NUMBER in cdn/shop/files/whatsapp-widget.js');
} else {
...
@media (max-width: 768px) {
  ...
  /* keep the floating button from covering footer content on phones */
  footer.footer {
    padding-bottom: 90px;
  }
}
...
const whatsappHTML = `
<a href="https://wa.me/${WHATSAPP_NUMBER}" class="whatsapp-float" target="_blank" title="Chat with us on WhatsApp">
